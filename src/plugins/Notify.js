...
import { createChildApp } from '../install-quark.js'
...
export default {
  ...
  registerType (typeName, typeOpts) {
    if (__QUARK_SSR_SERVER__ !== true && isPlainObject(typeOpts) === true) {
      notifTypes[ typeName ] = typeOpts
    }
  },

  install ({ $q, parentApp }) {
    $q.notify = this.create = __QUARK_SSR_SERVER__
      ? noop
    ...
    if (__QUARK_SSR_SERVER__ !== true && this.__installed !== true) {
